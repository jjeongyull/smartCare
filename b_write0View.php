...
<section>
    ...
    <div class="modBtn1">
            <a href="update.php?b_idx=<?= $row['b_idx'] ?>">수정</a>
        </div>
    ...
    ?>
      <div class="view-list"><span class="title">이전글</span><p class="view-prev">
            ...
            <a href="b_write0View.php?b_idx=<?=$p_array['b_idx']?>"> <?=$p_array['b_title']?></a>
            <?php }?>
            </p>
        </div>
        ...
        <div class="view-list"><span class="title">다음글</span><p class="view-next">
            <?php if(empty($n_array['b_idx'])){ ?>
              ...
              <a href="b_write0View.php?b_idx=<?=$n_array['b_idx']?>"> <?=$n_array['b_title']?></a>
              <?php }?>
              </p> 
        </div>
</section>          
