...
<section>
    ...
    <div class="section02">
        ...
        <?= $row['b_contents'] ?>
        <div class="download">
            <a href="file/<?= $row['b_file'] ?>" download=""><img src='./img/sub04/file-regular1.png' alt=''><?= $row['b_file'] ?></a>
        </div>
        </div>
    ...
    ?>
      <div class="view-list"><span class="title">이전글</span><p class="view-prev">
            ...
            <a href="view2.php?b_idx=<?=$p_array['b_idx']?>"> <?=$p_array['b_title']?></a>
            <?php }?>
            </p>
        </div>
        ...
        <div class="view-list"><span class="title">다음글</span><p class="view-next">
            <?php if(empty($n_array['b_idx'])){ ?>
              ...
              <a href="view2.php?b_idx=<?=$n_array['b_idx']?>"> <?=$n_array['b_title']?></a>
              <?php }?>
              </p> 
        </div>
</section>
