...
<body>
    ...
    <section>
        ...
        <div class="section03">
            ...
            ?>
                      ...
                      <div class='col2'><a href='b_write0View.php?b_idx=<?= $row['b_idx'] ?>'><?= $row['b_title'] ?></a></div>
    ...
    <?php
            ...
            if($block > 1) {
                $prev=$first-1;
            ?>  
            <a href='b_write0.php?page=1' id='prev' class="page">
                이전
            </a>
            <?php
                }
            ...
            $go_page=$page-1;
            ?>
                <a href='b_write0.php?page=<?=$go_page?>' class="page">
                이전
                </a>
        <?php
                }
        ...
        ?>
            <a href='b_write0.php?page=<?=$page_link?>' class="page">
                <?=$page_link?>
            </a> 
        <?php
            }
        ...
        <?php
                ...
                $next_page=$page+1;
        ?>
                <a href='b_write0.php?page=<?=$next_page?>' class="page">
                        이전
                </a>
        <?php
                }
                if ($last = $total_page) {
        ?>
        <a href='b_write0.php?page=<?=$total_page?>' class="page">
            다음
        </a>
